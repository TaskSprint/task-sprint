...
return [
    ...
    | настраивать каждое из этих сообщений здесь.
    |
    */
    ...
    'phone' => 'Поле :attribute должно быть действительным номером телефона, пример: +380951234567, и только для украинских номеров 0951234567.',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Следующие строки языка используются для замены нашего заполнителя атрибута
    | на что-то более читабельное, например, "Адрес электронной почты" вместо "email".
