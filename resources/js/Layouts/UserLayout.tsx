...
export default function UserLayout({ children }: Readonly<{ children: React.ReactNode }>) {
    ...
    return (
        <div className="item-center bg-surface/50 mx-auto flex h-full w-full flex-col gap-8 sm:p-6 2xl:max-w-[96rem] 2xl:flex-row 2xl:p-0">
            <main
                className={cn(
                    'w-full 2xl:py-8 2xl:pl-8',
            ...
            <div className="2xl:top-navbar-height flex h-fit flex-col pt-4 2xl:sticky 2xl:h-[calc(100dvh-var(--spacing-navbar-height))] 2xl:flex-row 2xl:py-12 2xl:pr-8">
                <Divider className="2xl:w-divider bg-muted 2xl:h-full" />

                <div className="overflow-hidden sm:rounded-b-[2rem] 2xl:rounded-r-[2rem] 2xl:rounded-bl-none">
                    <div className="bg-surface flex h-full flex-col overflow-y-auto px-9 pb-12 2xl:max-w-min">
                        <div className="flex w-full max-w-sm items-end justify-center py-[1.875rem] 2xl:h-36">
                            <div className="flex w-full items-center justify-between gap-8">
                                <div>
                                    <div className="text-[2.5rem] leading-none font-medium">
                                        12456
                                    </div>
