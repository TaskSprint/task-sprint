...
export default function EmployeeInfo() {
    ...
    return (
        <div className="mx-auto flex flex-col items-start text-[1.5rem] leading-[2.0625rem] font-normal">
                    ...
                    <div className="flex flex-col justify-center items-start p-3 gap-3 text-[1.5rem] leading-[2.0625rem] font-normal">
                        ...
                        <div>
                            {user1.phone ? (
                                ...
                                <div className="text-muted"> {t('profile.become-employee.field_missing')}</div>
                            )}
                        </div>
                    </div>
                ...
                <div className="flex flex-col justify-center items-start p-3 gap-3 text-[1.5rem] leading-[2.0625rem] font-normal">
                    ...
                    <div className="flex flex-wrap gap-[1.5rem]">
                        ...
                        {user1.certificates?.map(cert => (
                            <div
                                key={cert.id}
                                className="relative group w-[11.875rem] h-[6.563rem] rounded-md shadow-md overflow-hidden"
                            >
                                <Image
                                    src={cert.image}
                                    alt="Certificate"
                        ...
                        <Link className="relative group w-[11.875rem] h-[6.563rem] rounded-md bg-muted/50 shadow-md"
                              onPress={() => setUploadedFileModalOpen(true)}
                        >
                            <div className="absolute inset-0 z-10 flex items-center justify-center rounded-md gap-[1.5rem] bg-black/50 opacity-50 group-hover:opacity-100 transition-opacity duration-300">
