    ...
    return (
        <div className="mx-auto flex flex-col gap-[3.75rem] px-[2rem] py-[1rem]">
            ...
            <div className="flex flex-col items-start gap-[1.25rem] text-[1.5rem] leading-[2.0625rem] font-normal">
                ...
                <div className="grid w-full grid-cols-[22rem_1fr] gap-y-6">
                    {/* 1. Ім’я користувача */}
                    ...
                    <div className="text-primary">
                        {user1.username ? (
                            ...
                            <span>{t('profile.general-info.add')}</span>
                        )}
                    </div>
            ...
            <div className="mx-auto flex w-full max-w-[25.5625rem] flex-col gap-[1.5rem]">
                <Button className="bg-primary w-full rounded-full px-[1rem] py-[0.875rem] text-[1.5rem] leading-[2.0625rem] font-bold text-white">
                    {t('profile.become-employee.save_changes')}
                </Button>

                <Button className="bg-danger w-full rounded-full px-[1rem] py-[0.875rem] text-[1.5rem] leading-[2.0625rem] font-bold text-white">
